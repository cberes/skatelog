...
@pytest.mark.parametrize("notes,expected_tricks", [
    ...
    ("3 switch blunt nose grabs in the bowl", [
        Trick(day=DAY, name="blunt nose grab", stance=Stance.SWITCH, surface="bowl", count=3),
    ]),
    ("3 switch blunt nose grabs on 4' QP", [
        Trick(day=DAY, name="blunt nose grab", stance=Stance.SWITCH, surface="4' QP", count=3),
    ]),
