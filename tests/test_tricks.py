...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "3 switch blunt nose grabs",
            [
                Trick(day=DAY, name="blunt nose grab", stance=Stance.SWITCH, count=3),
            ],
        ),
        (
            "3 switch blunt nose grabs in the bowl",
            [
                Trick(
                    day=DAY, name="blunt nose grab", stance=Stance.SWITCH, surface="bowl", count=3
                ),
            ],
        ),
        (
            "3 switch blunt nose grabs on 4' QP",
            [
                Trick(
                    day=DAY, name="blunt nose grab", stance=Stance.SWITCH, surface="4' QP", count=3
                ),
            ],
        ),
        (
            "nollie bigspin, 2 fakie boardslide",
            [
                Trick(day=DAY, name="bigspin", stance=Stance.NOLLIE),
                Trick(day=DAY, name="boardslide", stance=Stance.FAKIE, count=2),
            ],
        ),
        (
            "switch blunt nose grab (3 regular, 4 switch)",
            [
                Trick(day=DAY, name="blunt nose grab", count=3),
                Trick(day=DAY, name="blunt nose grab", stance=Stance.SWITCH, count=4),
            ],
        ),
        (
            "switch blunt nose grab (3 regular, 4 switch), nollie bigspin",
            [
                Trick(day=DAY, name="bigspin", stance=Stance.NOLLIE),
                Trick(day=DAY, name="blunt nose grab", count=3),
                Trick(day=DAY, name="blunt nose grab", stance=Stance.SWITCH, count=4),
